...
import authImage from '../assets/img1 (3).jpeg'
import Form from 'react-bootstrap/Form';
//both login and regiter page are  almost same
            ...
            <div className='row align-items-center'>
              ...
              <div className='col-lg-6 col-md-6'>
                <div className='d-flex align-items-center flex-column'>
                  <h3><i class="fa-brands fa-stack-overflow me-3"></i>iProject Fair</h3>
                  <h5 className='text-light mt-3'>{
                    registerForm ? "Signup your account" : "Sigin your account"
                  }
                    <Form>
                      {
                        registerForm &&
